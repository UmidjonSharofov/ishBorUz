                ...
                <form onSubmit={addWorker}>
                    <div className={styles.row}>
                        <div className={styles.col_four}>
                            ...
                            <div className={styles.input_group}>
                                <label>Ish tajribangiz (yilda)*</label>
                        ...
                        <div className={styles.col_four}>
                            <div className={styles.input_group}>
                                <label>Ismingiz va tug'ilgan yilingiz*</label>
                                <input value={name} onChange={(event => setName(event.target.value))} required placeholder='Misol: Ahror Masharipov 2000 yil'/>
                            </div>
                            <div className={styles.input_group}>
